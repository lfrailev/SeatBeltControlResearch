...
%%
 ...
 global Vo   %%Car velocity before crash in km/h
    ...
    k=80     %%Lap seat belt as Spring
    b=900   %%Sash seat belt as Damper
    b2=1800  %%Lap seat belt as Damper
    G=0      %%consider (1) or not (0) gravity
    ...
    tlim=0:0.001:1   %%Time at which to end the integration
options = odeset('Events',@ThetaLimit,'Refine',refine,'AbsTol',1e-6);
[t,y] = ode45(@Research461F,tlim,[0 ThetaD0 0 XD0],options);
whos
plot(t,y(:,1))
xlabel('Time')
ylabel('Theta [rads]')
